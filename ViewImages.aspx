<%@ Page Title="" Language="C#" MasterPageFile="~/Image.Master" AutoEventWireup="true" CodeBehind="ViewImages.aspx.cs" Inherits="SFLite.ViewImages" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function MpageBack() {  // called by Image Master back button
            ...
            window.location = 'PickRooms.aspx?' + hfprm.value;
        }

        function ShowCarousel(img, loc) {
            hfprm = document.getElementById('<%= hfParams.ClientID %>');
            window.location = 'Carousel.aspx?' + hfprm.value + '&img=' + img.toString() + '&loc=' + loc.toString();
        }
...
<div id="RoomList" runat="server">
    ...
    <div id="imageContent" style="padding-top:5px;padding-right:5px; padding-left:5px;" runat="server">
        <div id="Div1" class="ui grid" runat="server"><% getSlides(); %></div>
    </div>
</div>
</asp:Content>
