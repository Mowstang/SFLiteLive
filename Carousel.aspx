<%@ Page Title="" Language="C#" MasterPageFile="~/Image.Master" AutoEventWireup="true" CodeBehind="Carousel.aspx.cs" Inherits="SFLite.Carousel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MpageBack() {  // called by Image Master back button
            ...
            window.location = 'ViewImages.aspx?' + hfprm.value;
        }
